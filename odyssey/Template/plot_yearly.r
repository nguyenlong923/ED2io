...
#----- Paths. -----------------------------------------------------------------------------#
here           = "/Users/longuyen/EDmodel/ED2_output/paracou_hydro0"    # Current directory.
there          = "/Users/longuyen/EDmodel/ED2_output/paracou_hydro0"    # Directory where analyses/history are 
srcdir         = "/Users/longuyen/EDmodel/ED2io/Long_Rutils" # Source  directory.
outroot        = "/Users/longuyen/EDmodel/ED2_output/paracou_hydro0" # Directory for figures
#------------------------------------------------------------------------------------------#
...
yearend        = 2009    # Maximum year to consider
...
drought.mark   = 0          # Put a background to highlight droughts?
drought.yeara  = 0         # First year that has drought
drought.yearz  = 0         # Last year that has drought
months.drought = 0        # Months with drought
...
for (place in myplaces){
   ...
   #---------------------------------------------------------------------------------------#
   path.data  = file.path(here,"rdata_month")
